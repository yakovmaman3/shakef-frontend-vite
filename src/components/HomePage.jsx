    ...
    <div className="relative text-white">
      ...
      >
        ...
        <div className="backdrop-blur-md bg-black/30">
          {/* כאן מועבר setShowPhone כמו שצריך */}
